...
import lab2.drdaniela.Cipher1;

public class DataEncryptionStandardDES implements Cipher1 {
    ...
    int[] PC1 = { 57, 49, 41, 33, 25, 17, 9,  1,  58, 50,
    ...
    int[] PC2 = { 14, 17, 11, 24, 1,  5,  3,  28, 15, 6,
    ...
    int[] P = { 16, 7, 20, 21, 29, 12, 28, 17, 1,  15, 23,
    ...
    @Override
    public String encrypt123(String message, String key) {
        return encrypt1(message, key);
    }

    @Override
    public String decrypt123(String message, String key) {
        return decrypt1(message, key);
    }
